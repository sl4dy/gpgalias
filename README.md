...
You can download VDI image with working solution [here](https://onedrive.live.com/redir?resid=51BE049EC23BE170!141&authkey=!AL0XuFvMXm9tiy0&ithint=file%2c7z). Just import the VDI to Virtualbox. Two network interfaces are used - one with Virtualbox only network and one with NAT to access the Internet. The memory requirement is 1 GB, but 512 MB should also work.
